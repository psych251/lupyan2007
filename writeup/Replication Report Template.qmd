...
The authors reported a partial eta-squared effect size of 0.07 for the interaction between condition and block. This roughly translates to a partial cohen's f of 0.87. This is a very large effect size. 

Original effect size, power analysis for samples to achieve 80%, 90%, 95% power to detect that effect size.  Considerations of feasibility for selecting planned sample size.

### Planned Sample

I plan to stop collecting data once I have 76 participants, 19 in each condition. The original study had 75 participants, and I adjusted it to 76 to have an even number of participants in each group.

Participants will be required to be fluent in English, so that they will understand the instructions of the task.
